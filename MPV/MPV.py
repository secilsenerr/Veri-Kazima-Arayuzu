...
class WebScrapperExtended(WebScrapper):
    ...
    def parse(self):
        '''next butonuna basilarak bir sonraki sayfaya (varsa) gitmemiz lazim
        '''
    ...
    def get_next_page(self, link):
        '''Eger bir next sayfasi varsa o sayfanin tam adresinin dondurur. Yoksa None doner.
        '''
...
class AyiklamaEkrani(tk.Frame):
    ...
    def parse_if_not_parsed(self):
        ''' Daha onceden veri ayiklandiysa DB dosyasi kullanilacak sadece.
    ...
    def initGui(self):
        ...
        # linklerin sag tiklandiginda acilmasi icin
    ...
    def select_event(self, event):
        ''' Bu kisim linklere tiklandiginda web sayfasi acilsin diye yapildi 
        '''
